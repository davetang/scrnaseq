...
* t-distributed stochastic neighbor embedding (t-SNE) - t-SNE is an algorithm used for dimensionality reduction and visualisation of high-dimensional data. Below is a brief overview of how t-SNE works:
    ...
    * Initialize embeddings: Next, t-SNE randomly initialises the embedding for each data point in the low-dimensional space.
